...
function automatorwp_zoom_ajax_authorize() {
    ...
    if( empty( $client_id ) || empty( $client_secret ) ) {
        wp_send_json_error( array( 'message' => __( 'All fields are required to connect with Zoom', 'automatorwp-zoom' ) ) );
    }
    ...
    wp_send_json_success( array(
        'message' => __( 'Zoom settings saved successfully, redirecting to Zoom...', 'automatorwp-zoom' ),
